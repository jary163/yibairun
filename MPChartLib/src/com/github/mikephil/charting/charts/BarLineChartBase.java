...
public abstract class BarLineChartBase extends Chart {
    ...
    protected void init() {
       ...
       // mXLabelPaint.setColor(Color.BLACK);
        mXLabelPaint.setColor(Color.rgb(237, 47, 56));
       ...
       // mYLabelPaint.setColor(Color.BLACK);
        mYLabelPaint.setColor(Color.rgb(237, 47, 56));
        ...
        mBorderPaint.setColor(Color.rgb(237, 47, 56));
...
//        float space = Math.abs(mDeltaY / 100f * 15f);
    ...
    protected void drawXLabels() {
        ...
        float yoffset = Utils.convertDpToPixel(20.5f);

        mXLabelPaint.setTypeface(mXLabels.getTypeface());
        mXLabelPaint.setTextSize(mXLabels.getTextSize());

        if (mXLabels.getPosition() == XLabelPosition.TOP) {
            drawXLabels(getHeight() - yoffset);
            Log.e("main","getHeight():"+getHeight()+ "getOffsetTop():"+getOffsetTop()+"   yoffset:"+yoffset);
            ...
            Log.e("main", "getHeight():"+getHeight()+"  mOffsetBottom:"+mOffsetBottom+"   yoffset:"+yoffset);
        } else { // BOTH SIDED
    ...
    protected void drawBorder() {
        ...
        for (int i = 0; i < mBorderPositions.length; i++) {
        	Log.e("main", "mBorderPositions:"+mBorderPositions[i]);
