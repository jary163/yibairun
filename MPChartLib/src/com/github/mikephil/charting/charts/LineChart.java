...
public class LineChart extends BarLineChartBase {
    ...
    protected void init() {
        ...
        mFilledPaint.setColor(mColorDarkRed);
        ...
        mHighlightPaint.setColor(mColorDarkRed);
            ...
            for (int i = 0; i < mCurrentData.getDataSetCount(); i++) {
                ...
                for (int j = 0; j < positions.length * mPhaseX; j += 2) {
                    ...
                    if (mDrawUnitInChart) {
                        ...
                        mDrawCanvas.drawText(mFormatValue.format(val)+"%", positions[j],//toggle
    ...
    protected void drawAdditional() {
        ...
        mRenderPaint.setStyle(Paint.Style.FILL);
        mRenderPaint.setAntiAlias(true);// ȥ���
        ArrayList<LineDataSet> dataSets = (ArrayList<LineDataSet>) mCurrentData.getDataSets();
