...
public class Constant {
	 ...
	 * 是否显示离线消息图标
	 */
	public static final String IS_VISIBLE_OFFLINE_ICON = "is_visible_offline_icon";
	
	
	/**
	 * shareprefer数据保存
	 */
	public static final String SETTING_SEX = "sex_setting";
	public static final String SETTING_VIDEO = "video_setting";
	public static final String SETTING_PUSH = "push_setting";
	 ...
	 * 注册提示
	 */
	public static final int REGISTER_SECCESS  = 0;//成功
	public static final int REGISTER_FAIL  = 1;//失败
	public static final int REGISTER_SERVER_NOT_RESPONSE  = 2;//服务器没响应
	public static final int REGISTER_EXIST_USER  = 3;//存在相同的用户名
	 ...
	 * 登录页面跳转行为
	 */
	public static final String LOGIN_ACTION = "action";//登录行为
	public static final int LOGIN_ACTION_DEFAULT = 0;//默认跳转行为
	public static final int LOGIN_ACTION_LOGOFF = 1;//注销账号
	 ...
	 * 系统设置
	 */
	public static final String SYSTEM_SET = "system_set";// 系统设置
	/**
	 * 请求某个操作返回的状态值
	 */
	 ...
	 * 服务器重启，请求重新连接服务器
	 */
	public static final String ACTION_RECONNECT_SERVICE = "action_reconnect_service";
