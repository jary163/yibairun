...
public class SettingAboutActivity extends BaseActivity {
	...
	public void initDate() {
       /* bar.setDisplayHomeAsUpEnabled(true);
		...
		String versinInfo = MessageFormat.format(versionCode.getText().toString().trim(), appController.getVersionName());
		versionCode.setText(versinInfo);
	}
	...
	public void initListener() {
        ...
        versionCode.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                clipboard.setPrimaryClip(ClipData.newPlainText(null, versionCode.getText()));
